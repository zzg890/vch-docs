 ...
 **Note:**  1. The Access Level will only be truly saved after you click the "Save" button. 2. Clicking the "Cancel" button will restore the content to the last saved version.
