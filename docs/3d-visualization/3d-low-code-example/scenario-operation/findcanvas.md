...
**Description:** Annotate the first image that meets the criteria in the query scenario
...
Write the above code on the button, click the button, and you can query the first matching model in the scene whose name includes canvas
