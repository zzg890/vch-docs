...
**Description: Obtain the name of the model**
...
console.log(box. name)// Console output box name
```
 
**Example:**

Write the above code on the button, click the button, and the model name can be output on the console.
