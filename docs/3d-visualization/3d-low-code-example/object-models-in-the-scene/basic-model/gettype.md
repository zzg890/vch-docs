...
**Description: Obtain the type of the model**
...
console.log(box.getType())// Console output box type
```
 
Example:

Write the above code on the button, click the button, and the model type can be output on the console.

![1](../../../../assets/images/3d_lowcode_object_bmodel_gettype1.gif)
