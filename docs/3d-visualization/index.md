...
In addition to supporting traditional 2D visualization, WAGO SCADA also supports more powerful 3D visualization. You can create 3D visualization projects just like you create 2D visualizations. At the same time, 3D visualization also provides a more powerful and flexible low-code platform, allowing you to build a true 3D digital twin application.

Description of 3D files supported on WAGO SCADA:
