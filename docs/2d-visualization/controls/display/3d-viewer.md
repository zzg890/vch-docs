...
**Notes:**  
- The six pictures in the sky box must have the same width and height, and the width and height of each picture must also be the same. 
- Skybox pictures only support png and jpg formats. 
