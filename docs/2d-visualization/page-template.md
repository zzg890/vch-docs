...
| Layout           | You can set the size of each area. Click the button below to set how the area is tiled horizontally and vertically.    <br> ![alt text](70.png)  Spread the page to the left.     <br>![alt text](71.png)  Spread the page to the right.     <br>![alt text](72.png) Spread the page to the upwards.  <br>![alt text](73.png) Spread the page to the down.    |
